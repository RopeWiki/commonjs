...
function waterflow() {
    ...
    if (!wftest && !wfnousgs) {
        ...
        function usgsgetval(date, today, imode) {
            ...
            var url = "https://usgs-cache.coops.workers.dev/nwis/" + (imode ? "iv" : "dv") + "/?format=json&bBox=" + usgsrect.join(",") + dates;
            ...
            $.getJSON(url, function(data) {
                ...
                var loadingRow = document.getElementById("usgs-loading-row");
                if (loadingRow) {
                    loadingRow.innerHTML = '<td colspan="' + table.getElementsByTagName("TH")[0].parentNode.childNodes.length + '" style="text-align:left; padding:20px; font-style:italic; color:#c00;">' + "Failed to load USGS gauge data. Please try refreshing the page.</td>";
                }
            }).always(function() {
        ...
        loadingRow.innerHTML = '<td colspan="' + table.getElementsByTagName("TH")[0].parentNode.childNodes.length + '" style="text-align:left; padding:20px; font-style:italic; color:#666;">' + '<img height=16 src="' + SITE_BASE_URL + '/extensions/PageForms/skins/loading.gif"/> Loading USGS gauge data...</td>';
