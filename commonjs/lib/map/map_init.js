...
function loadInteractiveMap() {
    ...
    if (kmllistquery != null) {
        ...
        kmllisturl = SITE_BASE_URL + '/api.php?action=ask&format=json&query=' + kmllistquery.innerHTML + '|%3FHas_coordinates|%3FHas_star_rating|%3FHas_summary|%3FHas_banner_image_file|%3FHas_location_class|%3FHas_KML_file|%3FRequires_permits|%3FHas_best_season_parsed|limit=100';
