...
function initializeLeafletMap() {
    $.when($.getScript("/leaflet/1.9.4/leaflet.js")).then(function() {
        buildLeafletMap();
    }, function(e) {
        mw.log.error(e);
    });
...
function buildLeafletMap() {
    ...
    window.map = L.map("mapbox", {}).setView([ 0, 0 ], 14);
...
function setupLeafletKML() {
    ...
    L.KMLIcon = L.Icon.extend({
        ...
        applyCustomStyles: function(img) {
            ...
            this.options.popupAnchor = [ 0, -.83 * height ];
...
function pdfselect(elem) {
    ...
    count = 1; else if (opt == "S") url = SITE_BASE_URL + "/PDFDownload?pagename=" + id + "&ext=.rw";
    url = rwlink(url, opts);
    if (url == "") return;
    elem.value = "";
    elem.blur();
