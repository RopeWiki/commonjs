...
function initializeLeafletMap() {
    ...
    $.getScript("/leaflet/1.9.4/leaflet.js").then(function() {
        return Promise.all([ $.getScript("https://unpkg.com/leaflet.vectorgrid@latest/dist/Leaflet.VectorGrid.bundled.js"), $.getScript("/leaflet-fullscreen/1.0.1/leaflet.fullscreen.min.js") ]);
    }).then(function() {
        buildLeafletMap();
    }).catch(function(e) {
        mw.log.error(e);
                    ...
                    function printLayerNames(layers) {
                        Object.keys(layers).forEach(function(key) {
                            ...
                            if (layer.options && layer.options.name && layer.options.color) {
                                ...
                                document.getElementById("legend-contents").innerHTML += '<i style="background: ' + layer.options.color + '; width: 12px; height: 12px; display: inline-block;"></i> ' + layer.options.name + " " + lengthStr + "<br>";
                            }
                            if (layer._layers) {
