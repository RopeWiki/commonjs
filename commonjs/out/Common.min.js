...
function initializeLeafletMap() {
    ...
    $.getScript("/leaflet/1.9.4/leaflet.js").then(function() {
        return Promise.all([ $.getScript("/leaflet-fullscreen/1.0.1/leaflet.fullscreen.min.js"), $.getScript("https://unpkg.com/leaflet.vectorgrid@latest/dist/Leaflet.VectorGrid.bundled.js") ]);
    }).then(function() {
        buildLeafletMap();
    }).catch(function(e) {
        mw.log.error(e);
