// Compute the distance between two (lat,lng) points in miles.
// Args:
//   p1: Object with lat and lng properties, each in degrees.
//   p2: Object with lat and lng properties, each in degrees.
// Returns:
//   Miles between the specified points.
...
// Args:
//   str: String representation of a distance, possibly followed by up-down arrow (unicode 2195) and then a height in
//     feet, sometimes with a non-breaking space (e.g., "2.7", "1.5&nbsp;\u21951000").
//   cnv: Conversion function accepting (float value, bool hasSpace) and returning a string representation of the
//     appropriately-rounded value followed by units.
// Returns:
//   Human-readable string with units according to locale (e.g., "2.7mi", "1.5&nbsp;mi \u21951000&nbsp;ft").
